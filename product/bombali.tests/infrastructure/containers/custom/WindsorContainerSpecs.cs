namespace bombali.tests.infrastructure.containers.custom
{
    using System;
    using bdddoc.core;
    ...
    {
        public abstract class concern_for_windsor_container : observations_for_a_sut_with_a_contract<IContainer, WindsorContainer>
        {
            ...
            concerns_using_a_real_container
        {
            ...
            context c = () => { the_container.AddComponent("h", typeof(ILogFactory), typeof(Log4NetLogFactory)); };
